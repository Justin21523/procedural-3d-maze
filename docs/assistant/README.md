...
This directory is a handoff-focused documentation hub for **ChatGPT / LLMProvider / Codex / other coding assistants**. The goal is to build an accurate mental model of how the game currently works (runtime wiring, update order, AI, content systems), and to know where to extend it safely.
