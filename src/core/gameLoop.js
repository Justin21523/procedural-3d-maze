...
export class GameLoop {
   ...
   */
  constructor(sceneManager, player, minimap = null, monsterManager = null, lights = null, worldState = null, gameState = null, exitPoint = null) {
  ...
  render() {
    ...
    if (this.minimap) {
      ...
      this.minimap.render(playerGridPos, monsterPositions, exitPosition);
    }
  }
